        ...
        Disposable
{
     ...
     */
    private WorldOfLearningMusic musicBeingPlayed;
        ...
        WorldOfLearningMusic music )
    {
        ...
        // do some logging
        Gdx.app.log( WorldOfLearning.LOG, "Playing music: " + music.name() );
    ...
    public void stop()
    {
        if( musicBeingPlayed != null ) {
            Gdx.app.log( WorldOfLearning.LOG, "Stopping current music" );
    ...
    public void setVolume(
        float volume )
    {
        Gdx.app.log( WorldOfLearning.LOG, "Adjusting music volume to: " + volume );
    ...
    public void dispose()
    {
        Gdx.app.log( WorldOfLearning.LOG, "Disposing music manager" );
        stop();
    }
}
