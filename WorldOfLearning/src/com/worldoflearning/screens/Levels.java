...
public class Levels extends AbstractScreen {
	...
	private class LevelSelectListener extends DefaultActorListener{
		...
		public void touchUp(InputEvent event, float x,float y,int pointer,int button ){
		    ...
		    if( actor.getName() == "level1Button") {
		        targetLevelId = 0;
		    } else if( actor.getName() == "level2Button" ) {
		        targetLevelId = 1;
		    } else if( actor.getName() == "level3Button" ) {
		        targetLevelId = 2;
		    } else if( actor.getName() == "level4Button" ) {
		        targetLevelId = 3;
		    }else {
		        return;
		    }
		    Gdx.app.log(WorldOfLearning.LOG, "curr world: " + targetWorldId);
		    Gdx.app.log(WorldOfLearning.LOG, "curr level: " + targetWorldId);
		    Gdx.app.log(WorldOfLearning.LOG, "curr world: " + profile.getCurrentWorldId());
		    Gdx.app.log(WorldOfLearning.LOG, "curr level: " + profile.getCurrentLevelId());
